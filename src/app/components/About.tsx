        ...
        <Card>
            <Card>
                <CardHeader className="text-3xl">
                    <h1 style={{ fontWeight: 'bold', textTransform: 'uppercase' }} className="font-bold text-large uppercase">О проекте:</h1>
                </CardHeader>
                <CardBody className='flex flex-col gap-3'>
                    <p>Меня зовут Александр Шатохин. Я автор проектов <Link href="https://dompredkov.ru/" target="_blank" underline='always'> "Дом предков"</Link>, <Link href="https://rod-i-predki.ru/" target="_blank" underline='always'> "Род и предки"</Link>. Генеалогией я увлекаюсь с 2008 года. Уже 13 лет исследую родословные для себя и на заказ. Мою родословную вы можете посмотреть по <Link href="https://i.ibb.co/KqjV3md/image.png?fbclid=IwAR31Bxh_6jQrYTxT7VNAxACPpyGIEBG8oj6GAdSIjikOYDV0LlvxkBkOX2o" target="_blank" underline='always'> ссылке</Link>, а отзывы клиентов посмотреть на <Link href="https://dompredkov.ru/otzyvy-2/" target="_blank" underline='always'>" странице с отзывами</Link>.</p>
                    <Divider />

                    <h3 style={{ fontWeight: 'bold', textTransform: 'uppercase' }} >История проекта:</h3>
                    <p>Свою родословную я изучаю уже 15 лет. Разрядный приказ ф.210 РГАДА позволяет взглянуть на служилое сословие 16-18 века под разными ракурсами. Где и когда служил человек, в каком полку, как бился в том или ином сражении, были ли поместья, как был вооружен, семья, дети, был ли ранен, убит и другие биографические подробности. На все эти вопросы охотно отвечает разрядный приказ РГАДА.</p>
                    ...
                    <p>Поэтому резюмируя, можно сказать, что получение информации из базы решает следующие вопросы:</p>
                    <ul>
                        <li>
            ...
            <Card>
                <CardHeader>
                    ...
                    <h3 style={{ fontWeight: 'bold', textTransform: 'uppercase' }}>По любой из этих записей вы можете заказать выписку, в которой содержатся:</h3>

                </CardHeader>
                <CardBody>
                    <ul>
                        <li>ФИО персоны (отчество есть в 95% записей). Если отчество указано в документе, то оно будет присутствовать в выписке;</li>
                        <li>фотокопия этой страницы дела;</li>
                        <li>дополнительно расшифровка текста в текстовом формате;</li>
                    </ul>
                </CardBody>
            </Card>
            <Card>
                ...
                <CardBody>
                    ...
                    <p>К каждой купленной записи прилагается фото страницы с упоминанием целевой персоны.</p>
                    <Divider />
                    ...
                    <p>Дополнительно к сканам я пришлю вам расшифровку текста документа в электронном виде.</p>
                </CardBody>
